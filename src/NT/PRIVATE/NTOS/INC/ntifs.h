...
//
// MicroNT: LSA client and MSV1_0 authentication-package surface removed.
// This fork has no Local Security Authority. Lsa*() prototypes, MSV1_0
// constants and structs (LM20 challenge/response, profile blobs, enum/get
// user info) have all been deleted along with lsakrnlp.lib.
//
...
// MicroNT: audit subsystem removed.
#define SeOpenObjectAuditAlarm(ObjectTypeName, Object, AbsoluteObjectName, SecurityDescriptor, AccessState, ObjectCreated, AccessGranted, AccessMode, GenerateOnClose) \
    do { if ((GenerateOnClose) != NULL) *(PBOOLEAN)(GenerateOnClose) = FALSE; } while (0)
...
// MicroNT: audit subsystem removed.
#define SeAuditingFileEvents(AccessGranted, SecurityDescriptor) ((BOOLEAN)FALSE)
