/*++ BUILD Version: 0076    // Increment this if a change has global effects
...
#define KSEG1_BASE 0x80800000           // end of kernel BAT
#define KSEG2_BASE 0x80800000           // end of kernel BAT
...
typedef struct _KTRAP_FRAME {
    ...
    ULONG Fill[4];      // padding for 32-byte stack frame alignment
