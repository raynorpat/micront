...
#ifdef NVME2K_DBG
                        /* %I64u isn't honoured by NT 3.5's DbgPrint vsprintf -
                           split into hi/lo and print as a 64-bit hex pair. */
                        ScsiDebugPrint(0, "nvme2k: Identified namespace - blocks=%08x%08x blocksize=%u bytes\n",
                                    (ULONG)(DevExt->NamespaceSizeInBlocks >> 32),
                                    (ULONG)(DevExt->NamespaceSizeInBlocks),
                                    DevExt->NamespaceBlockSize);
#endif
