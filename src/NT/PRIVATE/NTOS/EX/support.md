...
Source: `stuff/docs/support.doc` (transcribed via soffice + pandoc + cleanup-md.py).
...
*Lock* - A pointer to a spin lock to be used to synchronize access to
the *Addend* variable.

This function performs an interlocked add of an *Increment* value to an
*Addend* variable, and stores the result in the *Addend* variable. The
initial value of the *Addend* variable is returned as the function
value.
...
*ListHead* - A pointer to the head of the doubly linked list into which
...
*ListHead* - A pointer to the head of the doubly linked list from which
...
*ListHead* - A pointer to the head of the singly linked list into which
an entry is to be inserted.
...
*ListHead* - A pointer to the head of the singly linked list from which
an entry is to be removed.
...
3. Added section on the manipulation of singly linked interlocked
lists.
