...
WINUSERAPI BOOL    WINAPI _DrawCaptionTemp%(HWND, HDC, LPRECT, HFONT, HICON, LPTSTR%, UINT);
...
BOOL
WINAPI
GetClassInfoEx%(HINSTANCE, LPTSTR%, LPWNDCLASSEX%);
...
int
WINAPI
DrawTextEx%(HDC, LPCTSTR%, int, LPRECT, UINT, LPDRAWTEXTPARAMS);
#endif /* WINVER < 0x0400 */
#if(WINVER < 0x0400)
