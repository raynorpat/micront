...
Source: `stuff/docs/coding.doc` (transcribed via soffice + pandoc + cleanup-md.py).
...
*The /*++ <text> --*/ construct is used by a comment extractor
program that will be developed to assist in our documentation efforts.*
...
is included by each component of the executive and by the kernel, using
...
1. Extracted coding guidelines from exec.txt and converted text to
Word.
